...
export default function FeaturesWork({ img, title, location }) {
    ...
    return (
        <div className="font-display mt-12  ">
            <a href="#" className="relative group block w-80 md:w-120">
                <img
                    src={toyota}
                    alt="Toyota"
                    className="w-120 object-cover"
                />
                <div className="absolute inset-0 bg-black opacity-70 md:opacity-30 group-hover:opacity-70 transition duration-300"></div>
